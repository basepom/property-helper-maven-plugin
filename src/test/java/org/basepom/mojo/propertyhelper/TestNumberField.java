...
public class TestNumberField
{
    ...
    public void testThreeElements()
    {
        ...
        Assert.assertEquals(value, nf1.getPropertyValue().get());
        Assert.assertEquals(value, nf2.getPropertyValue().get());
        Assert.assertEquals(value, nf3.getPropertyValue().get());
    }
    ...
    public void testItsComplicated()
    {
        ...
        Assert.assertEquals(value, nf2.getPropertyValue().get());
        Assert.assertEquals(value, nf3.getPropertyValue().get());
        Assert.assertEquals(value, nf4.getPropertyValue().get());
    }
    ...
    public void testIncrementSingle()
    {
        ...
        Assert.assertEquals("foobar-2.2-barfoo-3", nf1.getPropertyValue().get());
    }
    ...
    public void testIncrement2()
    {
        ...
        Assert.assertEquals(8L, nf2.getNumberValue().longValue());
        Assert.assertEquals("5.8", nf1.getPropertyValue().get());
        Assert.assertEquals("5.8", nf2.getPropertyValue().get());

        nf2.increment();
        Assert.assertEquals(5L, nf1.getNumberValue().longValue());
        Assert.assertEquals(9L, nf2.getNumberValue().longValue());
        Assert.assertEquals("5.9", nf1.getPropertyValue().get());
        Assert.assertEquals("5.9", nf2.getPropertyValue().get());
    }
    ...
    public void testDoubleIncrement()
    {
        ...
        Assert.assertEquals("6.8", nf1.getPropertyValue().get());
        Assert.assertEquals("6.8", nf2.getPropertyValue().get());
    }
}
